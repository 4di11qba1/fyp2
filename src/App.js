        ...
        <AnimatePresence>
          <Router>
            <Routes>
              ...
              <Route exact path="/signin" element={<SignIn darkMode={darkMode} windowWidth={windowWidth} />} />
              <Route exact path="/signup" element={<SignUp darkMode={darkMode} windowWidth={windowWidth} />} />
            </Routes>
